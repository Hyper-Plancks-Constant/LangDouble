...
Possui **interface gráfica (Tkinter)**, mas está desatualizada. Utilizar o notebook Jupyter [`LangDouble_Notebook.ipynb`](./LangDouble_Notebook.ipynb) para realizar os cálculos com maior tranquilidade.
